...
namespace SHMUP
{
    ...
    public class BloomSettings
    {
        ...
        public static BloomSettings[] PresetSettings =
        {
           ...
           */
            new BloomSettings("workling",   0.5f,   2,   0.5f,     1,    1,       1,0),
            new BloomSettings("ChDefault",   0.5f,   2,   0.5f,     1,    1,       1,0),
            new BloomSettings("ChSlowMo",    0.2f,2.5f,  0.75f,  1.2f,    2,       0,0),
        };
    }
}
